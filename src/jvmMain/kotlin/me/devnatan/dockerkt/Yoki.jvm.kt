...
public actual class DockerClient public actual constructor(public actual val config: DocketClientConfig) : CoroutineScope {
    public constructor() : this(DefaultDocketClientConfig)
